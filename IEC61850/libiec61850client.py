...
class LinkedList(Structure):
    _fields_ = [("next", POINTER(c_void_p)), ("data", c_void_p)]
...
ReportCallbackFunction = CFUNCTYPE(UNCHECKED(None), POINTER(None), ClientReport)
...
class iec61850client():
    ...
    def report(con, error, cb, ds):
        ...
        cbRef = lib61850.ReportCallbackFunction(iec61850client.ReportHandler_cb)
...
if __name__=="__main__":
    ...
    if (error.value == lib61850.IED_ERROR_OK):
        ...
        iec61850client.report(con, error, cb="BCUCPLCONTROL1/LLN0$BR$brcbST01", ds="BCUCPLCONTROL1/LLN0$LLN0BRptStDs")
    ...
    cl = iec61850client()
    # model = cl.getDatamodel(None,'192.168.2.5',102)
    # cl.printrefs(model)

    # err = cl.registerReadValue("iec61850://192.168.2.5:102/BCUCPLMEASURMENT1/rmsMMXU1.Hz.mag.f")
