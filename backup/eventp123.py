    ...
    def pollEvent(self,port, unit):
        ...
        for i in range(0,len(ordered_data)):
            ...
            if ordered_data[i][6] == '0':
                ...
                eventData += 'Title='+ordered_data[i][0]+' Event : '+str(self.CodeNumber(ordered_data[i][2]))+'\n'
                ...
                eventData += 'Line '+str(4).rjust(3,'0')+'=-  Fault Magnitude Value ............................... '+str(ordered_data[i][7])+'\n'
                eventData += 'Line '+str(5).rjust(3,'0')+'=-  Phase A Magnitude (RMS) ............................. '+str(ordered_data[i][8])+'\n'
                eventData += 'Line '+str(6).rjust(3,'0')+'=-  Phase B Magnitude (RMS) ............................. '+str(ordered_data[i][9])+'\n'
                eventData += 'Line '+str(7).rjust(3,'0')+'=-  Phase C Magnitude (RMS) ............................. '+str(ordered_data[i][10])+'\n'
                eventData += 'Line '+str(8).rjust(3,'0')+'=-  Earth/Ground Magnitude (RMS) ........................ '+str(ordered_data[i][11])+'\n'
